...
for (Attr att : env.get_user_attributes()) {
    ...
    idx += ",";
    Lbl att_local_1 = env.attr_to_lbl(att);
    idx += env.lbl_to_string(att_local_1);
    idx += ",";
    idx += "0";
    idx += "}";
    tmp_z = ops.mul_z(tmp_z, msk.common_vars[idx]);
    ...
    idx += "r";
    idx += "_{";
    Auth att_local_2 = env.attr_to_auth(att);
    idx += env.auth_to_string(att_local_2);
    idx += "}";
    tmp_g = ops.fdh_g(1, idx);
    tmp_g = ops.scale_g(tmp_z, tmp_g);
    acc_g = ops.add_g(acc_g, tmp_g);
    ...
    idx += ",";
    Lbl att_local_4 = env.attr_to_lbl(att);
    idx += env.lbl_to_string(att_local_4);
    idx += ",";
    idx += "1";
    idx += "}";
    tmp_z = ops.mul_z(tmp_z, msk.common_vars[idx]);
    ...
    idx += "r";
    idx += "_{";
    Auth att_local_5 = env.attr_to_auth(att);
    idx += env.auth_to_string(att_local_5);
    idx += "}";
    tmp_g = ops.fdh_g(1, idx);
    tmp_g = ops.scale_g(tmp_z, tmp_g);
    acc_g = ops.add_g(acc_g, tmp_g);
